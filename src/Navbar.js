...
<div> 
    ...
    <nav class="navbar fixed-top navbar-expand-lg bg-dark navbar-dark">
            <div className="container">
                <a href="/" id="OCS" class=" navbar1 navbar-brand text-warning font-weight-bold">Food Cravings &nbsp;
                ...
                <ul class="navbar-nav ml-auto text-black ">
                    ...
                    <ButtonContainer>
                    <li class="nav-item">
                        <Link to="/Login_copy2" class="nav-link text-black"><i class="fa fa-shopping-bag" id="cartnav"></i> Cart</Link>
                    </li>
                    </ButtonContainer>
                   
                    <ButtonContainer>
                    <li class="nav-item">
                        <Link to="/Register" class="nav-link text-black"><i class="fa fa-user-plus"></i> Register</Link>
                    </li>
                    </ButtonContainer>
                    <ButtonContainer>
                    <li class="nav-item">
                        <Link to="/Login" class="nav-link text-black"><i class="fa fa-sign-in"></i> Login</Link>
                    </li>
                    </ButtonContainer>
                    <ButtonContainer>
                    <li class="nav-item">
                    ...
                    <ButtonContainer>
                    <li class="nav-item">
                        <Link to="/Feedback" class="nav-link text-black"><i class="fa fa-comment"></i> Feedback</Link>
                    </li>
                    </ButtonContainer>
                    {/* <li class="nav-item">
